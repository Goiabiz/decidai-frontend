...
export function RelatorioAtendimentos() {
  return (
    <>
      <PageHeader title="Relatório de Atendimentos" action={<button className="secondary-btn">Novo registro</button>} />
      ...
      <section className="workspace-settings-panel">
        <div className="workspace-settings-header">
          <div>
            ...
            <p>Consulta consolidada dos atendimentos por canal, cliente, fila, status, SLA e responsável.</p>
          </div>
