...
export function RelatorioAuditoria() {
  return (
    <>
      <PageHeader title="Relatório de Auditoria" action={<button className="secondary-btn">Novo registro</button>} />
      ...
      <section className="workspace-settings-panel">
        <div className="workspace-settings-header">
          <div>
            ...
            <p>Consulta de ações sensíveis, acessos, alterações, exportações e uso dos agentes.</p>
          </div>
