...
export function RelatorioAlertas() {
  return (
    <>
      <PageHeader title="Relatório de Alertas" action={<button className="secondary-btn">Novo registro</button>} />
      ...
      <section className="workspace-settings-panel">
        <div className="workspace-settings-header">
          <div>
            ...
            <p>Consulta de alertas emitidos, comunicados, tratados, concluídos e cancelados.</p>
          </div>
