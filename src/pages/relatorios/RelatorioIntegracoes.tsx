...
export function RelatorioIntegracoes() {
  return (
    <>
      <PageHeader title="Relatório de Integrações" action={<button className="secondary-btn">Novo registro</button>} />
      ...
      <section className="workspace-settings-panel">
        <div className="workspace-settings-header">
          <div>
            <h2>Relatório de Integrações</h2>
            <p>Consulta de provedores, conexões, recursos, erros e uso pelos agentes.</p>
          </div>
