...
export function RelatorioTarefas() {
  return (
    <>
      <PageHeader title="Relatório de Tarefas" action={<button className="secondary-btn">Novo registro</button>} />
      ...
      <section className="workspace-settings-panel">
        <div className="workspace-settings-header">
          <div>
            ...
            <p>Consulta das tarefas abertas, vencidas, concluídas, reatribuídas e vinculadas.</p>
          </div>
